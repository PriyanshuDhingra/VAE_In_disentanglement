...
def main():
    ...
    parser.add_argument('--dataset', choices=['mnist', 'mnist-U', 'mnist-N'], default='mnist-U',
                        help='which MNIST datset to train/validate on (default:mnist-U)')
    ...
    parser.add_argument('--path-to-mnist-test', default='./data/MNIST/processed/test.pt',
                        help='path to the file that has labels of the test images (default:./data/MNIST/processed/test.pt)')
    ...
    parser.add_argument('--clustering', default='k-means', choices=['agglomerative', 'k-means'],
                        help='agglomerative | k-means (default:k-means)')
    ...
    if args.dataset != 'mnist':
        ...
        rot_corr, tr_corr = measure_correlations(path_to_transformations, rot_pred - rot_pred_mnist,
                                                 tr_pred - tr_pred_mnist)
